{
  ...
  "components": [
    {
      "@id": "casssj:components/ActorQueryResultSerializeSparqlJson.jsonld#ActorQueryResultSerializeSparqlJson",
      "@type": "Class",
      ...
      "parameters": [
        {
          "@id": "casssj:components/ActorQueryResultSerializeSparqlJson.jsonld#ActorQueryResultSerializeSparqlJson_args_mediaTypePriorities",
          "range": "rdf:JSON",
          "default": {
            "@type": "@json",
            "@value": {
        ...
        {
          "@id": "casssj:components/ActorQueryResultSerializeSparqlJson.jsonld#ActorQueryResultSerializeSparqlJson_args_mediaTypeFormats",
          "range": "rdf:JSON",
          "default": {
            "@type": "@json",
            "@value": {
        ...
        {
          "@id": "casssj:components/ActorQueryResultSerializeSparqlJson.jsonld#ActorQueryResultSerializeSparqlJson_args_priorityScale",
          "range": {
        ...
        {
          "@id": "casssj:components/ActorQueryResultSerializeSparqlJson.jsonld#ActorQueryResultSerializeSparqlJson_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "casssj:components/ActorQueryResultSerializeSparqlJson.jsonld#ActorQueryResultSerializeSparqlJson_args_bus",
          "range": {
        ...
        {
          "@id": "casssj:components/ActorQueryResultSerializeSparqlJson.jsonld#ActorQueryResultSerializeSparqlJson_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "constructorArguments": [
        {
          "@id": "casssj:components/ActorQueryResultSerializeSparqlJson.jsonld#ActorQueryResultSerializeSparqlJson_args__constructorArgument",
          "fields": [
            {
